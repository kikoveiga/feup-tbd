...
ALTER TABLE "YCONCELHOS" ADD CONSTRAINT YCONCELHOS_DISTRITO_FK FOREIGN KEY("DISTRITO") REFERENCES "YDISTRITOS"("CODIGO");

ALTER TABLE "YFREGUESIAS" ADD CONSTRAINT YFREGUESIAS_CONCELHO_FK FOREIGN KEY("CONCELHO") REFERENCES "YCONCELHOS"("CODIGO");

ALTER TABLE "YVOTACOES" ADD CONSTRAINT YVOTACOES_PARTIDO_FK FOREIGN KEY("PARTIDO") REFERENCES "YPARTIDOS"("SIGLA");
ALTER TABLE "YVOTACOES" ADD CONSTRAINT YVOTACOES_FREGUESIA_FK FOREIGN KEY("FREGUESIA") REFERENCES "YFREGUESIAS"("CODIGO");

ALTER TABLE "YLISTAS" ADD CONSTRAINT YLISTAS_DISTRITO_FK FOREIGN KEY("DISTRITO") REFERENCES "YDISTRITOS"("CODIGO");
ALTER TABLE "YLISTAS" ADD CONSTRAINT YLISTAS_PARTIDO_FK FOREIGN KEY("PARTIDO") REFERENCES "YPARTIDOS"("SIGLA");

ALTER TABLE "YPARTICIPACOES" ADD CONSTRAINT YPARTICIPACOES_DISTRITO_FK FOREIGN KEY("DISTRITO") REFERENCES "YDISTRITOS"("CODIGO");
